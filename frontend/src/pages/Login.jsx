    ...
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-[60%] bg-white flex items-center justify-center px-6 sm:px-10 lg:px-20 py-12">
        ...
        <div className="w-full max-w-lg">
          ...
          <div className="flex justify-center">
            <button className="bg-[#E8A112] hover:bg-[#D8940D] text-white font-bold tracking-wider px-12 sm:px-16 py-3 sm:py-4 rounded-full shadow-lg transition-all duration-300">
              SIGN IN
            </button>
          </div>
      ...
      <div className="w-full md:w-[40%] min-h-[350px] md:min-h-screen bg-[#003B5C] relative overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-8">
          ...
          <button className="border-2 border-white px-10 sm:px-14 py-3 rounded-full font-bold tracking-wider hover:bg-white hover:text-[#003B5C] transition-all duration-300">
            SIGN UP
          </button>
